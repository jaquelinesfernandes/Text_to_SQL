...
# Projeto AI & SQL - AI SQL Query Generator Text-to-SQL
...
modelo_ai_dsa = genai.GenerativeModel('gemini-2.5-flash')
...
def main():
    ...
    st.set_page_config(page_title="AI & SQL - Jakye", page_icon=":100:", layout="wide")
    
    

    # Sidebar com instruções
    with st.sidebar:
        st.header("AI & SQL - Jakye")
        ...
        if st.button("Suporte"):
            st.write("Dúvidas? Envie um e-mail para: jackesilfe@gmail.com")
    ...
    st.markdown(
        ...
        <div style="text-align: center;">
            ...
            <h4>Sou Um Assistente de IA Customizado e Criador de Templates de Queries SQL!</h3>
            <h5>Disponível Download do Arquivo .sql.</h4>
            <hr style="margin:20px 0;">
        </div>
        """,
